...
| **QR Code** | Embeds a campaign QR code directly in the trigger. Visitors scan it on their phone to continue on mobile — with full campaign attribution. See [Campaigns — QR Code](/de/widget/campaigns#qr-code) for details. |
...
- Combine with [Custom Events](/de/widget/events#custom-events-api) for complex flows
