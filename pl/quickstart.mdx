...
<Frame caption="Registration form — Google OAuth or email">
...
<Frame caption="Company setup — name, website, logo, and contacts">
...
<Frame caption="Product card — description, price, photos, and knowledge base files">
...
<Frame caption="File Manager — uploading documents, links, text, and media">
...
<Frame caption="Agent knowledge base — selecting sources and training">
...
<Frame caption="Embed Code — widget installation code for your website">
