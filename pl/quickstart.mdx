...
<Tip>
  The basic workflow is sufficient for most scenarios: product consultations, FAQ answers, knowledge base search. For more complex scenarios (conditions, branches, custom tool calls), use the [Workflow Editor](/pl/agents/workflow).
</Tip>
