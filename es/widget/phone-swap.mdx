...
<Steps>
  <Step title="Configure phone swap in a campaign">
    Open a campaign and set the **Original Phone** (the number on your website) and the **Replacement Phone** (a tracking number assigned to this campaign). See [Campaigns — Phone Swap](/es/widget/campaigns#phone-swap) for setup details.
  </Step>
...
This tab is a **read-only summary** — to add or edit phone swap rules, open the campaign in the [Campaigns](/es/widget/campaigns) tab and configure the Phone Swap section.
...
<AccordionGroup>
  ...
  <Accordion title="Offline marketing (print, billboards)">
    Create a campaign for your print ads with a unique `rvl_ref` parameter. Add a dedicated phone number. When someone calls the number from the flyer — you know it came from print, not digital. Combine with a [QR code](/es/widget/campaigns#qr-code) for digital tracking of the same material.
  </Accordion>
