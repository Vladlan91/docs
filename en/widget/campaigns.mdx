...
<AccordionGroup>
  ...
  <Accordion title="Triggers and popups">
    Use the QR code inside **website triggers** — modal windows, slide-ins, or overlays that appear based on visitor behavior. For example, show a popup with a QR code that visitors can scan on their phone to continue the conversation later. Learn more in the [Triggers](/en/widget/triggers) section.
  </Accordion>
