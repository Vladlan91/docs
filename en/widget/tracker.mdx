...
description: "Website visitor tracking, analytics dashboard, campaigns, events, and triggers"
---
...
The Tracker page has 7 tabs: **Dashboard**, Campaigns, Sessions, Events, Triggers, Activity Log, and Phone Swap. This page covers the Dashboard tab in detail.
...
The Tracker page includes additional tabs beyond the Dashboard:

| Tab | Description |
|---|---|
| **Campaigns** | Create and manage tracking campaigns with UTM parameters |
| **Sessions** | Browse all sessions with drill-down to individual visitor journeys |
| **Events** | Define custom events (clicks, forms, scroll, visibility), toggle conversion goals |
| **Triggers** | Create automated actions based on visitor behavior (time, scroll, exit intent, page count) |
| **Activity Log** | Raw event log of the last 500 events, filterable by type |
| **Phone Swap** | Track phone number substitution for call attribution |
