...
<Frame caption="Tracker Dashboard — analytics overview with KPIs, charts, and geographic data">
...
<Frame caption="KPI cards — Sessions, Unique Visitors, Bounce Rate, Avg Duration, Pages/Visit, Conversions">
...
<Frame caption="Sessions Over Time — daily sessions and unique visitors trend">
...
<Frame caption="New vs Returning visitors — donut chart breakdown">
  <img className="block dark:hidden" src="/images/tracker-new-returning-light.png" alt="New vs returning visitors" />
  <img className="hidden dark:block" src="/images/tracker-new-returning-dark.png" alt="New vs returning visitors" />
</Frame>

## Devices

A breakdown of sessions by device type with counts and percentage bars:

- **Desktop** — computers and laptops
- **Mobile** — smartphones
- **Tablet** — tablets and similar devices

<Frame caption="Device breakdown — Desktop, Mobile, Tablet distribution">
  <img className="block dark:hidden" src="/images/tracker-devices-light.png" alt="Device breakdown" />
  <img className="hidden dark:block" src="/images/tracker-devices-dark.png" alt="Device breakdown" />
</Frame>
...
<Frame caption="Top Pages — most visited pages with views, time, and scroll depth">
...
<Frame caption="Traffic Sources — top sources with visitor count and bounce rate">
  <img className="block dark:hidden" src="/images/tracker-traffic-sources-light.png" alt="Traffic sources" />
  <img className="hidden dark:block" src="/images/tracker-traffic-sources-dark.png" alt="Traffic sources" />
</Frame>
...
<Frame caption="Visitor Globe — interactive 3D geographic visualization">
  <img className="block dark:hidden" src="/images/tracker-globe-light.png" alt="Visitor globe" />
  <img className="hidden dark:block" src="/images/tracker-globe-dark.png" alt="Visitor globe" />
</Frame>
...
<Frame caption="All Countries — sessions and visitors by country">
  <img className="block dark:hidden" src="/images/tracker-countries-light.png" alt="Countries list" />
  <img className="hidden dark:block" src="/images/tracker-countries-dark.png" alt="Countries list" />
</Frame>
...
<Frame caption="Session Duration — distribution of visit lengths">
  <img className="block dark:hidden" src="/images/tracker-session-duration-light.png" alt="Session duration histogram" />
  <img className="hidden dark:block" src="/images/tracker-session-duration-dark.png" alt="Session duration histogram" />
</Frame>
...
<Frame caption="Scroll Depth — how far visitors scroll on your pages">
  <img className="block dark:hidden" src="/images/tracker-scroll-depth-light.png" alt="Scroll depth histogram" />
  <img className="hidden dark:block" src="/images/tracker-scroll-depth-dark.png" alt="Scroll depth histogram" />
</Frame>
...
<Frame caption="Hourly Traffic — session distribution by hour of day">
  <img className="block dark:hidden" src="/images/tracker-hourly-traffic-light.png" alt="Hourly traffic chart" />
  <img className="hidden dark:block" src="/images/tracker-hourly-traffic-dark.png" alt="Hourly traffic chart" />
</Frame>
...
<Frame caption="Top Events — most frequently triggered event definitions">
  <img className="block dark:hidden" src="/images/tracker-top-events-light.png" alt="Top events chart" />
  <img className="hidden dark:block" src="/images/tracker-top-events-dark.png" alt="Top events chart" />
</Frame>
...
<Frame caption="Trigger Activity — most active automated triggers">
  <img className="block dark:hidden" src="/images/tracker-trigger-activity-light.png" alt="Trigger activity chart" />
  <img className="hidden dark:block" src="/images/tracker-trigger-activity-dark.png" alt="Trigger activity chart" />
</Frame>
...
<Frame caption="Campaign Performance — top campaigns with full metrics breakdown">
  <img className="block dark:hidden" src="/images/tracker-campaign-performance-light.png" alt="Campaign performance table" />
  <img className="hidden dark:block" src="/images/tracker-campaign-performance-dark.png" alt="Campaign performance table" />
</Frame>
